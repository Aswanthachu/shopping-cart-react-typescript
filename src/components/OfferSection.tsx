        ...
        <div className="w-1/2  lg:p-10 flex flex-col justify-between">
          ...
          <div className="w-full flex justify-center">
            <Button
              text="Add to cart"
              type="button"
              className="bg-white hover:bg-black hover:text-white rounded-full text-black border-2 border-black hover:border-white hover:text-white flex px-8 py-3 text-sm my-5 lg:my-0 lg:text-lg font-semibold items-center gap-2   text-center max-w-[250px]"
