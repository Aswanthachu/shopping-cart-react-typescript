...
const FeaturedBanner = () => {
  return (
    <div className="font-mons flex  px-5 md:px-10 lg:px-16 w-full gap-10 my-2 lg:my-8">
      <div className=" lg:pl-28 lg:pr-16 w-full  my-5 lg:my-0 flex flex-col lg:flex-row justify-between">
        <div className="w-full lg:w-6/12  border-[3px] border-black rounded-tl-[100px]  flex flex-col">
          ...
          <div className=" border-t-[3px] border-black w-full text-center py-1">
            <h1 className="text-[24px] lg:text-[45px] font-medium italic">
              Happy Rakshabandhan!
            </h1>
          </div>
        </div>
        <div className=" w-full  lg:w-5/12 space-y-10 lg:space-y-7 flex flex-col justify-between mt-5">
